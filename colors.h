...
// The first 8 colors work fine on VisualStudio
// All the 16 colors work fine on Ed, Repl.it, MacOS,
// and OnlineGDB
const int DARK_RED = 1;
const int DARK_GREEN = 2;
const int DARK_YELLOW = 3;
const int DARK_BLUE = 4;
const int DARK_MAGENTA = 5;
const int DARK_CYAN = 6;
const int GREY = 7;
const int DARK_GREY = 8;

// The colors below do not work on VisualStudio
const int RED = 9;
const int GREEN = 10;
const int YELLOW = 11;
const int BLUE = 12;
...
void print(int color, string str)
{
    ...
    if (color == DARK_RED)
        ...
        cout << termcolor::on_color<9>;
    else if (color == GREEN)
        cout << termcolor::on_color<10>;
    else if (color == YELLOW)
        cout << termcolor::on_color<11>;
    else if (color == BLUE)
        cout << termcolor::on_color<12>;
    else if (color == MAGENTA)
        cout << termcolor::on_color<13>;
    else if (color == CYAN)
        cout << termcolor::on_color<14>;
    else if (color == LIGHT_GREY)
        cout << termcolor::on_color<15>;
    else if (color == BLACK)
        cout << termcolor::on_color<16>;

    cout << str << termcolor::reset;
}
